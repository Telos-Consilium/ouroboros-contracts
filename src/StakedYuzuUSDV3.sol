 ...
 */
contract StakedYuzuUSDV3 is StakedYuzuUSDV2, AccessControlDefaultAdminRulesUpgradeable, IStakedYuzuUSDV3Definitions {
    ...
    /// @notice Reinitializes the contract for V3 upgrade
    /// @param _admin The admin of the contract
    // slither-disable-next-line pess-unprotected-initialize
    function reinitialize(address _admin) external reinitializer(3) {
